...
const About = () => {
    return (
        <div id="about" className="relative w-full min-h-screen z-10 py-20 px-6 md:px-12 flex flex-col items-center">
            ...
            {/* About Section */}
            <h2 className="font-nico text-white text-3xl sm:text-5xl md:text-7xl mb-8 md:mb-12 text-center drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] animate-fade-in-up">
                About SPACEUP
            </h2>

            <div className="w-full max-w-5xl bg-[#2E1C3B]/60 backdrop-blur-md border border-purple-500/30 rounded-3xl p-6 md:p-12 mb-16 md:mb-20 shadow-[0_0_50px_rgba(75,0,130,0.3)] animate-fade-in-up" style={{ animationDelay: '200ms' }}>
                <p className="font-tilt text-white/90 text-base md:text-2xl leading-relaxed text-left md:text-center">
            ...
            {/* Past Events Section */}
            <h2 className="font-nico text-white text-3xl sm:text-5xl md:text-7xl mb-8 md:mb-12 text-center drop-shadow-[0_0_15px_rgba(255,255,255,0.4)] animate-fade-in-up" style={{ animationDelay: '400ms' }}>
                Past events
            </h2>

            <div className="w-full max-w-5xl flex flex-col gap-8 md:gap-12 relative z-20">
                {/* SSS 2024 Card */}
                <div className="w-full bg-gradient-to-br from-purple-900/50 to-indigo-900/50 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-12 relative shadow-[0_0_40px_rgba(75,0,130,0.4)] animate-fade-in-up" style={{ animationDelay: '600ms' }}>
                    <div className="absolute inset-0 bg-black/20 rounded-3xl"></div>
                    <div className="relative z-10 flex flex-col gap-4 md:gap-6">
                        <div className="border-b border-white/10 pb-4 mb-2">
                            <h3 className="font-nico text-white text-2xl md:text-5xl mb-2 drop-shadow-lg">Students Space Summit (SSS) 2024</h3>
                            <p className="font-tilt text-purple-200 text-sm md:text-xl tracking-widest uppercase">A Legacy of Inspiration</p>
                        </div>
                        
                        <div className="font-tilt text-white/90 text-sm md:text-xl leading-relaxed space-y-4">
                            <p>
                ...
                {/* SOLSTICE 2025 Card */}
                <div className="w-full bg-gradient-to-br from-indigo-900/50 to-blue-900/50 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-12 relative shadow-[0_0_40px_rgba(59,130,246,0.3)] animate-fade-in-up" style={{ animationDelay: '800ms' }}>
                    <div className="absolute inset-0 bg-black/20 rounded-3xl"></div>
                    <div className="relative z-10 flex flex-col gap-4 md:gap-6">
                        <div className="border-b border-white/10 pb-4 mb-2">
                            <h3 className="font-nico text-white text-2xl md:text-5xl mb-2 drop-shadow-lg">SOLSTICE 2025</h3>
                            <p className="font-tilt text-blue-200 text-sm md:text-xl tracking-widest uppercase">Virtual Horizons</p>
                        </div>
                ...
                {/* STELLARX Card */}
                <div className="w-full bg-gradient-to-br from-pink-900/50 to-rose-900/50 backdrop-blur-md border border-white/10 rounded-3xl p-6 md:p-12 relative shadow-[0_0_40px_rgba(236,72,153,0.3)] animate-fade-in-up" style={{ animationDelay: '1000ms' }}>
                    <div className="absolute inset-0 bg-black/20 rounded-3xl"></div>
                    <div className="relative z-10 flex flex-col gap-4 md:gap-6">
                        <div className="border-b border-white/10 pb-4 mb-2">
                            <h3 className="font-nico text-white text-2xl md:text-5xl mb-2 drop-shadow-lg">STELLARX</h3>
                            <p className="font-tilt text-rose-200 text-sm md:text-xl tracking-widest uppercase">Innovate to Orbit</p>
                        </div>
