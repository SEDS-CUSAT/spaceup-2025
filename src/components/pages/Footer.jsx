            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto flex flex-col items-center">
                ...
                <div className="flex gap-6 mb-12">
                    {[
                        ...
                        { name: 'Instagram', href: 'https://www.instagram.com/ires_cusat', path: "M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z M17.5 6.5h.01 M12 2a10 10 0 0 1 10 10 10 10 0 0 1-10 10 10 10 0 0 1-10-10 10 10 0 0 1 10-10z" },
